...
function init(){
	...
	var confmKey = "U01TX0FVVEgyMDE5MDcyOTEyMDAxNzEwODkxMzk=";//승인키
...
<body onload="init();">
	<form id="form" name="form" method="post">
		...
		입력값 : <input type="text" id="resultType" name="resultType" value="<%=roadAddrPart1 %>" /> 
		<input type="button" value="확인" onClick="window.open('','_self').close();">
